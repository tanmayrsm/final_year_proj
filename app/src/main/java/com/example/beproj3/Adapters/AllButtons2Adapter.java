...
import com.example.beproj3.objo_brief_desc;
...
public class AllButtons2Adapter extends RecyclerView.Adapter<AllButtons2Adapter.AllUsersViewholder> {
    ...
    public AllButtons2Adapter(Activity context ,ArrayList<wordsModel> words){
...
//                    String uska_id = user.getUserid();
                    ...
                    ((objo_brief_desc)context).viewWord(wo);
                }
            });
